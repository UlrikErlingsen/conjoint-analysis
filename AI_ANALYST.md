...
- Do not convert part-worths to willingness-to-pay: dividing by a price coefficient assumes a linear, well-estimated price utility and routinely overstates precision.
